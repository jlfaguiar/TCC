...
df = pd.read_excel("detalhado_temp_0.7.xlsx")
...
metrics_output_path = "metricas_temp_0.7.xlsx"
...
plt.title("Matriz de Confusão - Temperatura 0.7")
plt.xlabel("Predito")
plt.ylabel("Real")
plt.tight_layout()

conf_matrix_output_path = "matriz_confusao_temp_0.7.png"
